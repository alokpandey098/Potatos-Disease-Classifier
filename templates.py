...
list_of_files = [
    ...
    f"src/{project_name}/pipeline/stage02_prepare_base_model.py",
    f"src/{project_name}/pipeline/stage03_training.py",
    f"src/{project_name}/pipeline/stage04_evaluation.py",
    ...
    "research/prepare_callbacks.ipynb",
